    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to PureHealth, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using PureHealth, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          PureHealth is designed to simplify healthcare access. You can choose
